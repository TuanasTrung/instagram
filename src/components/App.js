    ...
    <div className="App">
      <div className="full">
        ...
        <div className="ig-right">
            ...
            <div className="ig-top-center">
              ...
              <div className="infor">
                <div className="line-1">
                  ...
                  <button className="editProfile" onClick={() => setEdit(true)}>Edit profile</button>
          ...
          {edit === true && <EditProfile dataFromParent={linkAva} userNameFromParent={userName} handleSubmitForm={onHandleSubmitForm} handleCancel={onHandleCancel}/>}
        </div>
      </div>
